...
function darbuotojas($a, $b, $c){//pirma funkcija pagamina masyva
return [
...
$petras = darbuotojas ("Petras", "Petraitis", "mokinys");

//var_export($petras) turetu atitikt var_dump
...
$kolegos []= darbuotojas ("Jonas", "Jonaitis", "mokinys");
$kolegos []= darbuotojas ("kolega", "Jonaitis", "mokinys");

//var_export($kolegos):
echo "<hr/>"; //"<hr></hr>"   =  <hr/> ; hr atlieka ta pacia funkcija kaip <br> tik uzdeda bruksni
